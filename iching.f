C     Contributed by 'Irvise' from #fortran on libera.chat
C     https://paste.debian.net/1256532/
C     Must be compiled using the following string:
C     gfortran -ffixed-form -ffixed-line-length-none -w -std=legacy
C
C     The subroutine WAVEC is still undefined, and must be written manually
...
C        IF MULTIPLE OF 6 PRINT
  ...
  530 FORMAT(//1X,13HMEAN FOR EACH/1X,12H64 POSITIONS,1X,I5,1X,5(13X,
     ...
     3 19X,16HHIGHEST VALUE = ,I5,2X,19HAND ITS POSITION = ,I3)
C
C
